...
public class GrammarCellsSubstituteMenu_IBlock extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IBlock() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_drkicg_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IBlock", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_drkicg_a extends GrammarCellsSubstituteMenuPart {
    @Override
