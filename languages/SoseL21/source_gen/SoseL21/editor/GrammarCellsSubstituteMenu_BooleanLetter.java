...
public class GrammarCellsSubstituteMenu_BooleanLetter extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BooleanLetter() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_1mq0yx_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BooleanLetter", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_1mq0yx_a extends GrammarCellsSubstituteMenuPart {
    @Override
