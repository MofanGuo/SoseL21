...
public class GrammarCellsSubstituteMenu_Assertion extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Assertion() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_n8r54j_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Assertion", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_n8r54j_a extends GrammarCellsSubstituteMenuPart {
    @Override
