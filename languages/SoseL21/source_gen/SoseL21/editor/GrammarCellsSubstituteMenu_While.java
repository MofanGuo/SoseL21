...
public class GrammarCellsSubstituteMenu_While extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_While() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_eb3glm_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "While", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_eb3glm_a extends GrammarCellsSubstituteMenuPart {
    @Override
