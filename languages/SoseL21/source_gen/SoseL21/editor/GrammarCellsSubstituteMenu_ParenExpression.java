...
public class GrammarCellsSubstituteMenu_ParenExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ParenExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_rx5jkj_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ParenExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_rx5jkj_a extends GrammarCellsSubstituteMenuPart {
    @Override
