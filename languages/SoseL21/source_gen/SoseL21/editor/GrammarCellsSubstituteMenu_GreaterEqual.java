...
public class GrammarCellsSubstituteMenu_GreaterEqual extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_GreaterEqual() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_gp4baz_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "GreaterEqual", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_gp4baz_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.GreaterEqual$zL;
    }
  }
