...
public class GrammarCellsSubstituteMenu_BinaryInteger extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BinaryInteger() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_mpfpdc_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BinaryInteger", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_mpfpdc_a extends GrammarCellsSubstituteMenuPart {
    @Override
