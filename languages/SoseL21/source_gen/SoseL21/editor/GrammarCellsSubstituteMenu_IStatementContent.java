...
public class GrammarCellsSubstituteMenu_IStatementContent extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IStatementContent() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_lxh30b_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IStatementContent", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_lxh30b_a extends GrammarCellsSubstituteMenuPart {
    @Override
