...
public class GrammarCellsSubstituteMenu_Class extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Class() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_e5mpri_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Class", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_e5mpri_a extends GrammarCellsSubstituteMenuPart {
    @Override
