...
public class GrammarCellsSubstituteMenu_IntegerExpression extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IntegerExpression() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fxegd_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IntegerExpression", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fxegd_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.IntegerExpression$4G;
    }
  }
