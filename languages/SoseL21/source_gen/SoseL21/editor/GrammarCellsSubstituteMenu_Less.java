...
public class GrammarCellsSubstituteMenu_Less extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Less() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8h828q_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Less", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8h828q_a extends GrammarCellsSubstituteMenuPart {
    @Override
