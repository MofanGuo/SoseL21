...
/*package*/ class BinaryInteger_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BinaryInteger_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_al0d1z_a");
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            {
              ...
              SNode child = SLinkOperations.getTarget(node, LINKS.first$oXey);
              ...
              if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.IntegerExpression$4G))) {
                SNodeFactoryOperations.setNewChild(node, LINKS.first$oXey, null);
                return;
              }
            }

            SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.second$p2BT));
          ...
          public boolean canExecute_inReadAction(EditorContext editorContext) {
            ...
            SNode replacement = SLinkOperations.getTarget(node, LINKS.second$p2BT);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new firstSingleRoleHandler_al0d1z_a0a(myNode, LINKS.first$oXey, getEditorContext());
    return provider.createCell();
  }
  private static class firstSingleRoleHandler_al0d1z_a0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public firstSingleRoleHandler_al0d1z_a0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.first$oXey, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.first$oXey, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.first$oXey);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.first$oXey));
      try {
      ...
      public EditorCell invoke() {
        ...
        cell.setSubstituteInfo(new ConstantSubstituteInfo(getEditorContext(), myNode) {
          public List<IToken> getSyntaxElementsBefore(SNode node) {
            ...
            ListSequence.fromList(result).addElement(new ChildToken(SLinkOperations.getTarget(node, LINKS.first$oXey)));
            return result;
          }
          public List<IToken> getSyntaxElementsAfter(SNode node) {
            List<IToken> result = ListSequence.fromList(new ArrayList<IToken>());
            ListSequence.fromList(result).addElement(new ChildToken(SLinkOperations.getTarget(node, LINKS.second$p2BT)));
            return result;
          }
        });
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            ...
            SNode unwrapped = SNodeOperations.replaceWithAnother(node, SLinkOperations.getTarget(node, LINKS.first$oXey));
          ...
          public boolean canExecute_inReadAction(EditorContext editorContext) {
            ...
            SNode replacement = SLinkOperations.getTarget(node, LINKS.first$oXey);
            SContainmentLink containmentLink = node.getContainmentLink();
            if (containmentLink == null) {
              return true;
            }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_al0d1z_a0a1a");
      ...
      public EditorCell invoke() {
        cell.setAction(CellActionType.DELETE, new CellActionWithReadAccess() {
          public void execute(EditorContext editorContext) {
            {
              // replace with placeholder
              SNode child = SLinkOperations.getTarget(node, LINKS.second$p2BT);
              SAbstractConcept childConcept = SNodeOperations.getConcept(child);
              if (!(GrammarCellsUtil.isExactly(childConcept, CONCEPTS.IntegerExpression$4G))) {
                SNodeFactoryOperations.setNewChild(node, LINKS.second$p2BT, null);
                return;
              }
            }
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new secondSingleRoleHandler_al0d1z_a2a(myNode, LINKS.second$p2BT, getEditorContext());
    return provider.createCell();
  }
  private static class secondSingleRoleHandler_al0d1z_a2a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public secondSingleRoleHandler_al0d1z_a2a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.second$p2BT, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.second$p2BT, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.second$p2BT);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.second$p2BT));
      try {
        EditorCell editorCell = super.createEmptyCell();
