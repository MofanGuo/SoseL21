...
public class GrammarCellsSubstituteMenu_For extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_For() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bqa592_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "For", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bqa592_a extends GrammarCellsSubstituteMenuPart {
    @Override
