...
public class GrammarCellsSubstituteMenu_BinaryBoolean extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BinaryBoolean() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_71t9yd_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BinaryBoolean", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_71t9yd_a extends GrammarCellsSubstituteMenuPart {
    @Override
