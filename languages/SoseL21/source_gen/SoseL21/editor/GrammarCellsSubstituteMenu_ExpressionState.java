...
public class GrammarCellsSubstituteMenu_ExpressionState extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ExpressionState() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_3nfify_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ExpressionState", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_3nfify_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ExpressionState$5s;
    }
  }
