...
/*package*/ class Constructor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new paramsListHandler_ph8r7t_c0a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_params");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class paramsListHandler_ph8r7t_c0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public paramsListHandler_ph8r7t_c0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(paramsListHandler_ph8r7t_c0a.this.getNode(), LINKS.params$nbn5));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new blockListHandler_ph8r7t_b0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_block");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class blockListHandler_ph8r7t_b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public blockListHandler_ph8r7t_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(blockListHandler_ph8r7t_b0.this.getNode(), LINKS.block$nbP7));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_ph8r7t_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
