...
public class GrammarCellsSubstituteMenu_IfElse extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IfElse() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_e14bux_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IfElse", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_e14bux_a extends GrammarCellsSubstituteMenuPart {
    @Override
