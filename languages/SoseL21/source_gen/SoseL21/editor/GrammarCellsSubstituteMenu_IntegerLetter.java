...
public class GrammarCellsSubstituteMenu_IntegerLetter extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IntegerLetter() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_da8khg_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IntegerLetter", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_da8khg_a extends GrammarCellsSubstituteMenuPart {
    @Override
