...
public class GrammarCellsSubstituteMenu_Multiply extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Multiply() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_mznvds_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Multiply", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_mznvds_a extends GrammarCellsSubstituteMenuPart {
    @Override
