...
public class GrammarCellsSubstituteMenu_ExpressionStatementContent extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ExpressionStatementContent() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_z2v2wf_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ExpressionStatementContent", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_z2v2wf_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ExpressionStatementContent$5s;
    }
  }
