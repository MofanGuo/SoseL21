...
public class GrammarCellsSubstituteMenu_Divide extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Divide() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cvrkne_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Divide", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_cvrkne_a extends GrammarCellsSubstituteMenuPart {
    @Override
