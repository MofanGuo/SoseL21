...
public class GrammarCellsSubstituteMenu_AssignBoolean extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AssignBoolean() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_9rkhu6_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AssignBoolean", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_9rkhu6_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.AssignBoolean$AL;
    }
  }
