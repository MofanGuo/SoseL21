...
/*package*/ class IntegerLetter_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public IntegerLetter_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createSplittableCell_0() {
    ...
    try {
      ...
      SProperty property = PROPS.value$dkY0;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));

      CellProviderWithRole provider = new SplittablePropertyCellProvider(myNode, PROPS.value$dkY0, getEditorContext(), new NumberLiteralTokenizer());
