...
public class SMTestInterpreter_extension extends Extension.Default<IInterpreter> {
  public SMTestInterpreter_extension() {
  ...
  public IInterpreter get() {
    return new InterpreterSMTestInterpreter();
  }
}
