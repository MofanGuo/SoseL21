...
public class ParameterValuesSingleton {
  ...
  public static void enterScope() {
    ParameterValuesSingleton.INT_VALUES.enterScope();
    ParameterValuesSingleton.BOOL_VALUES.enterScope();
  }

  public static void exitScope() {
    ParameterValuesSingleton.INT_VALUES.exitScope();
    ParameterValuesSingleton.BOOL_VALUES.exitScope();
  }
